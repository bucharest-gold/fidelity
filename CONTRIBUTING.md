...
Open a [new issue](https://github.com/bucharest-gold/fidelity/issues/new)
...
Fork the project [on GitHub](https://github.com/bucharest-gold/fidelity)
and check out your copy locally.

```
git clone git@github.com:username/fidelity.git
cd fidelity
git remote add upstream https://github.com/bucharest-gold/fidelity.git
```
...
Go to https://github.com/yourusername/fidelity and select your feature branch.
